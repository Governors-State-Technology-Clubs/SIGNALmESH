...
def logger_setup(BackendQueue: queue.Queue):
    args = BackendQueue.get()

    if args.app is None:
        # TODO: Take in the application name from the system prompt
        # APP_NAME = 'CSS_Discord_Bot'
        pass
    ...
    # Checking Queue
    while BackendQueue.empty():
        pass
    SERVER_ID = BackendQueue.get()
    HOSTING = f"http://localhost:"
    logger = logging.getLogger(__name__)

    # TODO:Log out that the record has been started
    ...
    # TODO:Log the beginning of OTEL resource creation
    ...
    bot_resource = Resource(
        attributes={
            ...
            "service.app.python.info": str(sys.version_info),
    ...
    # Add Application name and app version to resource
    ...
    otel_handler = LoggingHandler(
        level=logging.NOTSET, logger_provider=resourced_logger
    )
